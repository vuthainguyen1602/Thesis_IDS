...
\begin{figure}[htbp]
    ...
    \end{tikzpicture}}
    \caption[Sơ đồ phân chia dữ liệu CICIDS2017]{Sơ đồ phân chia dữ liệu CICIDS2017: chia 80/20 thành train/test (\texttt{seed}=42); tập train tách tiếp 80/20 thành base-train và validation phục vụ chọn lọc, tập test được giữ lại chỉ để công bố kết quả cuối}
