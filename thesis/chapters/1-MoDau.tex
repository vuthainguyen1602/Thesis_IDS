...
\begin{itemize}
  ...
  \item Khảo sát hiệu suất hệ thống, hướng tới khả năng mở rộng, độ trễ thấp và tính linh hoạt; kiểm chứng khả năng xử lý phân tán ở mức minh chứng khái niệm (proof-of-concept) trên cụm thiết bị biên, làm tiền đề cho việc triển khai trên các hệ thống lớn hoặc mạng \ac{iot} nhiều thiết bị.
...
\begin{itemize}
  ...
  \item \textbf{Môi trường triển khai}: Thử nghiệm hệ thống trên một môi trường giả lập mạng \ac{iot} và bộ dữ liệu mô phỏng công khai (CICIDS2017) nhằm đánh giá khả năng phát hiện bất thường.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Nghiên cứu và đề xuất mô hình học máy, học sâu, học máy tổng hợp phát hiện bất thường sử dụng Spark Machine Learning}: Sử dụng nhiều thuật toán khác nhau như Decision Tree, Support Vector Machine, Logistic Regression, \ac{nb}, Random Forest, \ac{gbt}, \ac{xgb}, \ac{mlp} và các thuật toán Ensemble learning để xây dựng mô hình nhằm so sánh, đánh giá mô hình có hiệu suất tốt nhất.
...
\label{sec:DongGop}
\begin{itemize}
  \item \textbf{Đề xuất giải pháp ứng dụng Apache Spark trong phát hiện bất thường cho hệ thống mạng \ac{iot}}: Đề tài đã xây dựng một mô hình phát hiện bất thường dựa trên nền tảng xử lý dữ liệu lớn Apache Spark, tận dụng khả năng xử lý phân tán và thời gian thực của Spark, hướng tới đáp ứng yêu cầu về hiệu suất và tính mở rộng trong môi trường \ac{iot} có khối lượng dữ liệu lớn và biến đổi liên tục; khả năng xử lý phân tán được kiểm chứng ở mức minh chứng khái niệm (proof-of-concept) trên cụm thiết bị biên.
...
Một phần kết quả của luận văn được phát triển thành hai công trình khoa học (đồng tác giả Nguyễn Vũ Thái, Bùi Văn Dũng và Đỗ Trí Nhựt), hiện đang được hoàn thiện để gửi đăng:
\begin{enumerate}
