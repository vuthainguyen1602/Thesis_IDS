...
\vspace*{1ex}
    ...
    \caption{Mô hình 5V của dữ liệu lớn \cite{Husamaldin2020}}
    \label{fig:bigdata}
    \end{figure}
\vspace*{1ex}
\begin{itemize}
...
\vspace*{1ex}
    ...
    \caption{Các thành phần của Apache Spark \cite{Karau2015}}
    \label{fig:spark}
    \end{figure}
\vspace*{1ex}
...
\vspace*{1ex}
    ...
    \caption{Sơ đồ kiến trúc hệ thống Apache Spark \cite{Zaharia2016}}
