...
\begin{itemize}
  ...
  \item \textbf{Anomaly-based \ac{ids}}: Phát hiện hành vi bất thường dựa trên mô hình hoạt động bình thường, phù hợp với các cuộc tấn công chưa biết \cite{chandola2009anomaly,ruff2021unifying}; các bộ phát hiện dựa trên autoencoder \cite{lopez2017autoencoder,alrawashdeh2016toward} là một hướng phổ biến của nhóm này.
