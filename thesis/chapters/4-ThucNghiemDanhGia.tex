...
\begin{table}[htbp]
\centering
\caption[Phân tích loại bỏ (ablation) rò rỉ đặc trưng cổng đích]{Phân tích loại bỏ (ablation) rò rỉ: ảnh hưởng của đặc trưng \texttt{destination\_port} (Random Forest cố định a priori: \texttt{numTrees}=200, \texttt{maxDepth}=15, có trọng số lớp; nhị phân)}
