...
\begin{table}[htbp]
\centering
\caption[Tổng quát hóa liên bộ dữ liệu CICIDS2017 và CSE-CIC-IDS2018]{Tổng quát hóa liên bộ dữ liệu giữa CICIDS2017 và CSE-CIC-IDS2018 (trung bình qua bốn lượt chạy độc lập)}
\label{tab:cross_dataset}
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}llccc@{}}
\toprule
\textbf{Huấn luyện} & \textbf{Kiểm tra} & \textbf{Loại} & \textbf{F1} & \textbf{AUC-\ac{pr}} \\ \midrule
CICIDS2017 & CICIDS2017 & cùng bộ & 0{,}9954 & 0{,}9997 \\
CICIDS2017 & CSE-CIC-IDS2018 & khác bộ & 0{,}2154 $\pm$ 0{,}2562 & 0{,}4989 \\
CSE-CIC-IDS2018 & CSE-CIC-IDS2018 & cùng bộ & 0{,}9243 & 0{,}9675 \\
CSE-CIC-IDS2018 & CICIDS2017 & khác bộ & 0{,}0536 $\pm$ 0{,}0116 & 0{,}1862 \\ \bottomrule
\end{tabular*}
\tabnote{Bốn lượt chạy trên cùng mã nguồn và cùng dữ liệu, chỉ khác hạt giống của rừng ngẫu nhiên (42, 42, 7, 13). F1 khác bộ ghi kèm khoảng tin cậy 95\% (Student-$t$, $n=4$) vì đại lượng này \emph{không} tái lập được giữa các lượt chạy; khoảng giá trị quan sát được là 0{,}0449--0{,}3009 ở chiều 2017$\rightarrow$2018 và 0{,}0484--0{,}0587 ở chiều ngược lại. Các đại lượng cùng bộ (hệ số biến thiên $\le$ 0{,}1\%) và AUC-\ac{pr} (hệ số biến thiên $\le$ 6\%) ổn định nên chỉ ghi trung bình. Xem thảo luận ngay dưới bảng.}
\end{table}

\textbf{Diễn giải.} Kết quả cho thấy một tương phản rõ rệt: hiệu năng cùng bộ rất cao và rất ổn định ở cả hai chiều (F1 0{,}9954 và 0{,}9243, hệ số biến thiên dưới 0{,}1\% qua bốn lượt chạy), còn hiệu năng khác bộ rơi xuống mức không dùng được. Mức rơi đó được nhìn rõ nhất qua AUC-\ac{pr}, đại lượng không phụ thuộc ngưỡng quyết định và ổn định giữa các lượt chạy: từ 0{,}9997 xuống 0{,}4989 ở chiều 2017$\rightarrow$2018 và từ 0{,}9675 xuống 0{,}1862 ở chiều ngược lại, tức mất một nửa đến bốn phần năm khả năng xếp hạng luồng độc hại. F1 khác bộ trung bình 0{,}2154 (khoảng 0{,}0449--0{,}3009) và 0{,}0536 (khoảng 0{,}0484--0{,}0587); mức thấp này đến từ recall rất nhỏ (trung bình 0{,}126 và 0{,}030) trong khi precision vẫn còn khá (0{,}850 và 0{,}248), tức mô hình gần như không nhận ra tấn công của bộ dữ liệu kia, chứ không tạo ra cảnh báo sai tràn lan. Nguyên nhân là dịch chuyển phân phối đặc trưng giữa hai testbed: khác phiên bản CICFlowMeter (thang đo và cách tính một số đặc trưng thay đổi), khác hạ tầng mạng và cấu hình dịch vụ, khác tổ hợp loại tấn công (HOIC/LOIC-HTTP của 2018 không có trong 2017). Sự sụt giảm này nhất quán với các nghiên cứu cross-dataset trên IDS dựa trên đặc trưng luồng~\cite{dhooge2020interdataset,cantone2024crossdataset,sarhan2022explainable}, và củng cố luận điểm trung tâm của luận văn: con số trong-miền gần hoàn hảo, kể cả khi đã loại rò rỉ, không bảo đảm khả năng triển khai sang môi trường khác. Đánh giá liên bộ dữ liệu phải là một phần bắt buộc của quy trình kiểm định IDS~\cite{goldschmidt2025datasets}, và các hướng thích ứng miền (chuẩn hóa theo miền, huấn luyện liên bộ, cập nhật theo drift) là điều kiện tiên quyết cho triển khai thực tế.

\textbf{F1 khác bộ không phải một con số tái lập được.} Bốn lượt chạy ở Bảng~\ref{tab:cross_dataset} được thực hiện trên cùng mã nguồn, cùng tệp parquet và cùng danh sách đặc trưng; chỉ hạt giống của rừng ngẫu nhiên thay đổi. Vậy mà F1 chiều 2017$\rightarrow$2018 trải từ 0{,}0449 đến 0{,}3009, và \emph{hai lượt dùng chung hạt giống 42 cũng không trùng nhau} (0{,}3009 so với 0{,}2936). Nghĩa là nguồn dao động không nằm ở hạt giống mà ở chính quá trình huấn luyện phân tán: thứ tự các phân vùng được gộp lại khi Spark tính biểu đồ tần suất chia nút không cố định giữa các lượt, nên phép cộng số thực dấu phẩy động cho tổng lệch nhau ở những chữ số cuối và một vài ngưỡng chia nút được chọn khác đi.

Cơ chế khuếch đại sai lệch nhỏ đó thành nhảy bậc ở F1 chính là recall khác bộ rất thấp: với recall chỉ 0{,}02--0{,}18, xác suất dự đoán của gần như toàn bộ luồng tấn công miền đích nằm \emph{sát dưới} ngưỡng 0{,}5. Các luồng này lại rất giống nhau (cùng vài họ tấn công, cùng bộ công cụ sinh ra), nên khi vài cây trong rừng đổi ngưỡng chia, cả một cụm lớn luồng cùng dạng vượt ngưỡng hoặc tụt xuống dưới ngưỡng \emph{cùng lúc}, kéo recall và F1 nhảy bậc. Bằng chứng trực tiếp cho lời giải thích này là AUC-\ac{pr}: đại lượng không dùng ngưỡng ấy chỉ dao động khoảng 6\% giữa các lượt, trong khi F1 dao động 55\% --- thứ tự xếp hạng gần như không đổi, chỉ vị trí của ngưỡng 0{,}5 so với cụm đó là đổi.

Hệ quả về phương pháp đánh giá: một con số F1 khác bộ từ một lượt chạy duy nhất không phải kết quả báo cáo được. Mẫu 0{,}0423 --- con số từng được ghi trong các bản thảo trước của luận văn và của bài báo, và vẫn xuất hiện ở Bảng~\ref{tab:cross_adapt} với tư cách mức cơ sở của lượt chạy đó --- chỉ là một điểm của phân phối vừa mô tả. Trong luận văn, kết quả khác bộ vì vậy được báo cáo dưới dạng trung bình kèm khoảng tin cậy qua nhiều lượt chạy, và AUC-\ac{pr} được dùng làm đại lượng chính khi so sánh. Kết luận định tính --- hiệu năng gần hoàn hảo trong miền không chuyển sang được miền khác --- không hề bị lung lay: ngay ở lượt chạy tốt nhất, F1 khác bộ 0{,}30 vẫn cách F1 cùng bộ 0{,}99 một khoảng mà không cấu hình nào lấp được.
