...
CICIDS2017 & CSE-CIC-IDS2018 & khác bộ & 0{,}1321 $\pm$ 0{,}0715 & 0{,}4862 \\
...
\end{tabular*}
\tabnote{Mười hai lượt chạy trên cùng mã nguồn và cùng dữ liệu, dùng bảy hạt giống rừng ngẫu nhiên, trong đó năm hạt giống được lặp lại hai lượt. F1 khác bộ ghi kèm khoảng tin cậy 95\% (Student-$t$, $n=12$) vì đại lượng này \emph{không} tái lập được giữa các lượt chạy. Riêng ở chiều 2017$\rightarrow$2018, mười hai giá trị tách thành hai chế độ rời nhau (bảy lượt trong khoảng 0{,}029--0{,}084 và năm lượt trong khoảng 0{,}185--0{,}301, không có giá trị nào ở giữa), nên trung bình 0{,}1321 nằm đúng vào khoảng trống và không lượt nào thực sự cho giá trị đó --- xem thảo luận dưới đây. Các đại lượng cùng bộ (hệ số biến thiên $\le$ 0{,}1\%) và AUC-\ac{pr} chiều 2017$\rightarrow$2018 (0{,}453--0{,}536, hệ số biến thiên 4{,}9\%) thì ổn định.}
\end{table}

\textbf{Diễn giải.} Kết quả cho thấy một tương phản rõ rệt: hiệu năng cùng bộ cao và ổn định ở cả hai chiều (F1 0{,}9952 và 0{,}9246, hệ số biến thiên dưới 0{,}1\% qua 12 lượt chạy), còn hiệu năng khác bộ rơi xuống mức không dùng được. AUC-\ac{pr} cho thấy mức rơi này rõ nhất, vì nó không phụ thuộc ngưỡng quyết định và ổn định giữa các lượt chạy: từ 0{,}9997 xuống 0{,}4862 ở chiều 2017$\rightarrow$2018 và từ 0{,}9676 xuống 0{,}2072 ở chiều ngược lại, tức mất một nửa đến bốn phần năm khả năng xếp hạng luồng độc hại. F1 khác bộ trung bình 0{,}1321 (khoảng 0{,}0291--0{,}3009) và 0{,}0539 (khoảng 0{,}0484--0{,}0587); mức thấp này đến từ recall rất nhỏ (trung bình 0{,}075 và 0{,}030) trong khi precision vẫn còn khá (0{,}764 và 0{,}270), tức mô hình gần như không nhận ra tấn công của bộ dữ liệu kia, chứ không tạo ra cảnh báo sai tràn lan. Nguyên nhân là dịch chuyển phân phối đặc trưng giữa hai testbed: khác phiên bản CICFlowMeter (thang đo và cách tính một số đặc trưng thay đổi), khác hạ tầng mạng và cấu hình dịch vụ, khác tổ hợp loại tấn công (HOIC/LOIC-HTTP của 2018 không có trong 2017). Sự sụt giảm này nhất quán với các nghiên cứu cross-dataset trên IDS dựa trên đặc trưng luồng~\cite{dhooge2020interdataset,cantone2024crossdataset,sarhan2022explainable}, và củng cố luận điểm trung tâm của luận văn: con số trong-miền gần hoàn hảo, kể cả khi đã loại rò rỉ, không bảo đảm khả năng triển khai sang môi trường khác. Đánh giá liên bộ dữ liệu phải là một phần bắt buộc của quy trình kiểm định IDS~\cite{goldschmidt2025datasets}, và các hướng thích ứng miền (chuẩn hóa theo miền, huấn luyện liên bộ, cập nhật theo drift) là điều kiện tiên quyết cho triển khai thực tế.

\textbf{F1 khác bộ không phải một con số tái lập được.} Mười hai lượt chạy ở Bảng~\ref{tab:cross_dataset} dùng cùng mã nguồn, cùng tệp parquet và cùng danh sách đặc trưng; chỉ hạt giống của rừng ngẫu nhiên thay đổi, và năm hạt giống được chạy hai lượt để đo riêng phần dao động \emph{trong cùng một cấu hình}. Kết quả ở chiều 2017$\rightarrow$2018 không phải nhiễu quanh một giá trị trung tâm mà là \emph{hai chế độ rời nhau}: bảy lượt cho F1 0{,}029--0{,}084 với recall 0{,}015--0{,}045, năm lượt cho F1 0{,}185--0{,}301 với recall 0{,}104--0{,}178, và không một lượt nào rơi vào khoảng giữa 0{,}084 và 0{,}185.

Điều quyết định một lượt thuộc chế độ nào \emph{không phải} hạt giống. Trong năm hạt giống được lặp, ba hạt giống cho hai lượt cùng chế độ và lệch nhau rất ít (seed 42: 0{,}3009 và 0{,}2936; seed 23: 0{,}0411 và 0{,}0434; seed 31: 0{,}0291 và 0{,}0303), nhưng \emph{hai hạt giống đổi hẳn chế độ giữa hai lượt}: seed 5 cho 0{,}0495 rồi 0{,}1854, seed 11 cho 0{,}0843 rồi 0{,}2606. Nghĩa là cùng một hạt giống, cùng một tệp dữ liệu vẫn có thể cho hai kết quả cách nhau gấp bốn lần; nguồn dao động nằm ở chính quá trình huấn luyện phân tán, nơi thứ tự gộp các phân vùng khi Spark tính biểu đồ tần suất chia nút không cố định giữa các lượt, nên một vài ngưỡng chia nút được chọn khác đi.

Cơ chế khuếch đại sai lệch nhỏ đó thành hai chế độ là vị trí của ngưỡng quyết định 0{,}5. Xác suất dự đoán của gần như toàn bộ luồng tấn công miền đích nằm \emph{sát ngay} ngưỡng này, mà các luồng đó lại rất giống nhau (cùng vài họ tấn công, cùng bộ công cụ sinh ra), nên chúng không vượt ngưỡng một cách rời rạc: cả một cụm lớn cùng lật qua hoặc cùng tụt xuống dưới ngưỡng, đưa recall nhảy thẳng từ $\approx$0{,}03 lên $\approx$0{,}15 mà không đi qua các giá trị trung gian. Bằng chứng quyết định cho lời giải thích này là AUC-\ac{pr}: đại lượng không dùng ngưỡng ấy \emph{như nhau ở cả hai chế độ} (0{,}459--0{,}516 ở chế độ thấp so với 0{,}453--0{,}536 ở chế độ cao, hai khoảng trùm lên nhau hoàn toàn). Khả năng xếp hạng của mô hình không hề đổi giữa các lượt; chỉ vị trí của ngưỡng 0{,}5 so với cụm luồng đó là đổi.

Hệ quả về phương pháp đánh giá khá nặng. Thứ nhất, trung bình không phải một cách mô tả tốt cho phân phối hai chế độ: con số 0{,}1321 ở Bảng~\ref{tab:cross_dataset} nằm đúng vào khoảng trống giữa hai chế độ, tức \emph{không lượt chạy nào} cho giá trị ấy. Thứ hai, một con số F1 khác bộ từ một lượt chạy duy nhất không mang thông tin về mô hình mà chủ yếu cho biết lượt đó rơi vào chế độ nào --- mẫu 0{,}0423 từng được ghi trong các bản thảo trước của luận văn và của bài báo, và vẫn xuất hiện ở Bảng~\ref{tab:cross_adapt} với tư cách mức cơ sở của lượt chạy đó, là một mẫu thuộc chế độ thấp. Vì vậy luận văn báo cáo cả phân phối (số lượt mỗi chế độ và khoảng giá trị) và dùng AUC-\ac{pr} làm đại lượng chính khi so sánh khác bộ. Kết luận định tính không đổi: kể cả ở chế độ cao, F1 khác bộ 0{,}30 và AUC-\ac{pr} 0{,}49 vẫn cách rất xa mức cùng bộ 0{,}99 và 0{,}9997, và khoảng cách đó không cấu hình nào lấp được.
...
\multirow{3}{*}{2017 $\rightarrow$ 2018} & Không thích ứng & 0{,}0423 & 0{,}4720 \\
 & Chuẩn hóa theo miền & 0{,}0000 & 0{,}1742 \\
 & CORAL & 0{,}0000 & 0{,}2130 \\ \midrule
\multirow{3}{*}{2018 $\rightarrow$ 2017} & Không thích ứng & 0{,}0561 & 0{,}1994 \\
 & Chuẩn hóa theo miền & 0{,}0000 & 0{,}0880 \\
 & CORAL & 0{,}0000 & \textbf{0{,}2576} \\ \bottomrule
\end{tabular*}
\tabnote{Ba dòng của mỗi chiều đến từ \emph{cùng một lượt chạy} nên so sánh được với nhau. Mức cơ sở của lượt chạy này (0{,}0423 và 0{,}0561) thuộc \emph{chế độ thấp} của phân phối đã mô tả ở trên, còn mức cơ sở ở Bảng~\ref{tab:label_budget} (0{,}2939) thuộc chế độ cao --- hai lượt chạy khác nhau, hai chế độ khác nhau. Cần lưu ý phạm vi của kết luận ở đây: cả hai kỹ thuật đưa F1 về đúng 0, tức triệt tiêu mọi phán quyết tấn công, nhưng điều đó chỉ được đo trên một lượt chạy thuộc chế độ thấp. Vì chế độ không do hạt giống quyết định nên không thể chỉ định trước một lượt chế độ cao để kiểm chứng lại; đây là một hạn chế của thí nghiệm thích ứng, không phải của kết luận về chính sự bất ổn. Ánh xạ CORAL được kiểm chứng giải tích: sau khi ánh xạ, trung bình và hiệp phương sai của miền đích khớp miền nguồn với sai số tương đối $4\times10^{-12}$.}
\end{table}

Cả hai kỹ thuật đều \emph{không} khôi phục được F1: sau khi căn chỉnh, mô hình gần như ngừng báo tấn công nên F1 về 0. Điều này bác bỏ giả thuyết ``chỉ lệch thang đo'': nếu dịch chuyển nằm ở moment bậc một và bậc hai thì hai phép căn chỉnh này đã đủ, nhưng thực tế phần khác biệt nằm ở \emph{phân phối có điều kiện} --- cái gì làm một luồng trở thành độc hại --- cùng với việc hai testbed dùng bộ công cụ tấn công không trùng nhau. Tuy vậy có một chi tiết đáng chú ý: ở chiều 2018$\rightarrow$2017, CORAL \emph{cải thiện} AUC-\ac{pr} từ 0{,}1994 lên 0{,}2576 trong khi F1 vẫn bằng 0. Nghĩa là phép căn chỉnh có làm \emph{thứ tự xếp hạng} tốt lên, nhưng ngưỡng quyết định 0{,}5 học từ miền nguồn không còn hiệu lực trong không gian đặc trưng đã đổi. Bài học rút ra cho triển khai thực tế: thích ứng miền cho \ac{ids} không thể dừng ở căn chỉnh đặc trưng mà phải kèm \emph{hiệu chỉnh lại ngưỡng} trên miền đích.
...
\end{tabular*}
\tabnote{1\% được lấy từ \emph{tập huấn luyện} của miền đích, không bao giờ từ tập kiểm tra. Dòng ``không thích ứng'' lấy từ chính lượt chạy này để ba dòng so sánh được với nhau; mức cơ sở 0{,}2939 vì vậy là một lượt thuộc \emph{chế độ cao} của phân phối F1 khác bộ nói trên, trong khi Bảng~\ref{tab:cross_adapt} dùng một lượt thuộc chế độ thấp (0{,}0423). Kết luận rút ra dưới đây không phụ thuộc vào mức cơ sở cụ thể: kể cả khi so với mẫu cao nhất quan sát được (0{,}3009), mức tăng do 1\% nhãn vẫn là hơn một bậc độ lớn ở cả hai chiều.}
\end{table}
