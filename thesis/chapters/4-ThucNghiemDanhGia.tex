...
\begin{table}[htbp]
\centering
\caption{Kết quả hiệu năng phân lớp kịch bản Tối ưu hóa tham số}
...
\begin{table}[htbp]
\centering
\caption{Tổng quát hóa liên bộ dữ liệu giữa CICIDS2017 và CSE-CIC-IDS2018 (CSE-CIC-IDS2018: mẫu phân tầng \texttt{seed}=42; từ \texttt{cross\_dataset\_results.csv})}
...
\begin{figure}[htbp]
    ...
    \caption{Dashboard Grafana tại thời điểm tải đỉnh của chế độ tách pipeline: nút cổng (\texttt{jetson-nano-1}) chỉ sử dụng khoảng 5\,\% CPU trong khi nút phân loại PySpark (\texttt{jetson-nano-2}) đạt tới 91\,\%}
