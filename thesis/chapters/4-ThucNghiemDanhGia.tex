...
\begin{figure}[htbp]
    ...
    \caption{Dashboard Grafana tại thời điểm tải đỉnh của chế độ chia pipeline: nút cổng (\texttt{jetson-nano-1}) chỉ sử dụng khoảng 5\,\% CPU trong khi nút phân loại PySpark (\texttt{jetson-nano-2}) đạt tới 91\,\%}
