...
\begin{itemize}
    ...
    \item \textbf{Quy trình chọn mô hình thành phần cho ensemble}: Việc lựa chọn Top-3 mô hình thành phần cho ensemble dựa trên F1-Score đo trên tập kiểm tra (thay vì một tập validation tách riêng) có thể tạo ra một thiên lệch lạc quan nhẹ đối với các chỉ số công bố. Hướng khắc phục là tách riêng tập validation hoặc dùng kiểm định chéo (CV) để xếp hạng và chọn mô hình thành phần, giữ tập kiểm tra hoàn toàn độc lập cho khâu báo cáo cuối cùng.
