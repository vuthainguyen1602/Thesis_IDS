...
%   III Results, conclusion ........ 3:20   (4 slides)
...
\begin{frame}{Key references}
  \begin{itemize}\footnotesize
    ...
    \item Shi, W. et al. \emph{Edge computing: Vision and challenges}.
          IEEE Internet of Things Journal 3(5), 2016.
          \hfill{\key{edge setting}}
    \item Chandola, V., Banerjee, A. \& Kumar, V. \emph{Anomaly detection:
    ...
    \item Kreps, J., Narkhede, N. \& Rao, J. \emph{Kafka: a Distributed
          ...
          \hfill{\key{Kafka}}
    \item Mohan Kiran Kumar, K. et al. \emph{Distributed Intrusion Detection
