...
\begin{frame}{Result 1: splitting the pipeline buys 24$\times$ throughput}
  ...
  throughput at the tightest run-to-run spread; cluster mode is for models that
  exceed single-node memory.}
...
% ---------------------------------------------------------------- 0:45
\begin{frame}{Result 3: the price of one unified stack}
  ...
  \note{The JVM costs us three orders of magnitude, and that sets the
  roadmap.}
\end{frame}
