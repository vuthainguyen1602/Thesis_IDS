...
\begin{frame}{Result 4: the scores do not survive a different testbed}
  ...
  If asked about the wide F1 interval: at this recall the metric is fragile to
  where the threshold falls, so we average F1 over runs and judge the gap on
  AUC-PR. Consistent with prior cross-dataset IDS studies, and the reason domain
  adaptation is a prerequisite rather than a nice-to-have.}
\end{frame}
