...
\begin{frame}{Result 2: testing the difference instead of asserting it}
  ...
  \note{Variance reflects data sampling, not just model initialization. The
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.58\textwidth}
      ...
      \begin{itemize}\footnotesize
        \item \textbf{Mislabeled but caught}: 81/111 XSS land on Web Brute
    ...
    \begin{column}{0.50\textwidth}
      \begin{itemize}\small
        ...
        \item Driven by near-zero \emph{recall} (0.022 / 0.030) while precision
              (2017$\to$2018) stays at 0.596: the model \key{fails to recognize} the other
