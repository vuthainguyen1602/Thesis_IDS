  ...
  \begin{columns}[T]
    \begin{column}{0.46\textwidth}
      ...
      \begin{tabular}{lcc}
        ...
        \midrule
        2017 $\to$ 2017 & \good{0.9952} & \good{0.9997} \\
        2017 $\to$ 2018 & \bad{0.1321} \tiny$\pm$0.0706 & \bad{0.4862} \\
        2018 $\to$ 2018 & \good{0.9246} & \good{0.9676} \\
        2018 $\to$ 2017 & \bad{0.0539} \tiny$\pm$0.0022 & \bad{0.2072} \\
        \bottomrule
      \end{tabular}
      }
      \\[0.4em]
      \footnotesize
      Mean of 12 runs; shared leakage-free features, $\sim$2.39M flows.
    \end{column}
    \begin{column}{0.50\textwidth}
      \begin{itemize}\small
        \item In-domain stable \emph{both} ways --- cross-dataset AUC-PR
              \bad{1.00$\to$0.49} and \bad{0.97$\to$0.21}.
        \item Recall 0.075 / 0.030 at precision 0.764 / 0.270: the model
              \key{fails to recognize} the other testbed's attacks.
        \item 12 runs, \key{two disjoint regimes}: 7 at 0.029--0.085, 5 at
              0.185--0.301, nothing between. AUC-PR identical in both.
