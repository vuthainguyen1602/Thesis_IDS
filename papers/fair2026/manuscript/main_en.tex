...
\begin{table}[htbp]
  \caption{Cross-dataset generalization (CICIDS2017 and CSE-CIC-IDS2018, stratified sample \texttt{seed}=42; values from \texttt{cross\_dataset\_results.csv}).}
...
This work was carried out at the University of Transport and Communications (Ho Chi Minh City Campus) and the University of Information Technology, VNU-HCM, as part of a graduation thesis research project. The authors declare no conflict of interest.
