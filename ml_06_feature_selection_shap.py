...
base_output = ml_results_dir(ML06_DIR)
...
rf_importance_path = ml_results_dir(ML02_DIR, "feature_importance.csv")
...
if os.path.exists(rf_importance_path):
    ...
    print("  RF Feature Importance not found. Run ml_02 first for comparison.")
